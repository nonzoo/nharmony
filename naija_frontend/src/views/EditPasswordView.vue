        ...
        <div class="main-center col-span-2 space-y-4">
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                <form class="space-y-6" v-on:submit.prevent="submitForm">
                    ...
                    <div>
                        <button class="py-4 px-6 bg-purple-600 text-white rounded-lg">Save Password</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                axios
                    ...
                    .then(response => {
                        if (response.data.message === 'success') {
                            this.toastStore.showToast(5000,'The information was saved' ,'bg-emerald-300')
