            ...
            <div class="flex space-x-6">
                <div class="flex items-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 cursor-pointer" @click="likePost(post.id)">
                        <path v-if="post.isLiked" stroke-linecap="round" stroke-linejoin="round"
            ...
            axios
                ...
                .then(response => {
                    if (response.data.message === 'like created') {
                        ...
                        this.post.isLiked = true; // Set isLiked to true
                    }
                    else {
                        this.post.likes_count -= 1;
                        this.post.isLiked = false; // Set isLiked to false
                    }
                })
                .catch(error => {
